...
[![CI](https://github.com/ptdecker/urandom-kiss/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/ptdecker/urandom-kiss/actions/workflows/ci.yml)
